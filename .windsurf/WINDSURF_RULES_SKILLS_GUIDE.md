...
This guide is customized for the **YDM monorepo** - a Replit-based TypeScript project using pnpm workspaces with API-first development architecture.
...
- **Replit**: Autoscaling deployment with Node.js 24
